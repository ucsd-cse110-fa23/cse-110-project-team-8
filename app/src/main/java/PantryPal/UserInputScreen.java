    ...
    public UserInputScreen(RecipeListBody recipeList, Stage primaryStage, Scene mainScene, Generate generate,
        ...
        stopRecButton.setOnAction(e -> {
            ...
            if (firstInput == true) {
                ...
                RecipeDescriptionScreen generatedRecipeScreen = new RecipeDescriptionScreen(null, processedTitle,
                        processedIngredients, processedInstructions,
                        primaryStage, mainScene, recipeList);

                // Add generatedRecipeScreen into ScreenManager
                screenManager.setRecipeDescriptionScreen(generatedRecipeScreen);
