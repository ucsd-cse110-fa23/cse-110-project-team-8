...
public class DishImageTests{
    ...
    void createRecipeImage() {
        ...
        String userInstructions = "Make a recipe image of mealtype " + "mealType" + "with the recipe title " + recipeTitle;
    ...
    void createMultipleRecipeImage() {
        ...
        String userInstructions1 = "Make a recipe image of mealtype " + "mealType" + "with the recipe title " + recipeTitle1;

        String recipeTitle2 = "Eggs and Bacon";
        String userInstructions2 = "Make a recipe image of mealtype " + "mealType" + "with the recipe title " + recipeTitle2;

        String recipeTitle3 = "Eggs and Bacon";
        String userInstructions3 = "Make a recipe image of mealtype " + "mealType" + "with the recipe title " + recipeTitle3;
