...
public class PantryPalTests {
    ...
    void testAddtoRecipeList() {
        Recipe testRecipe = new Recipe("testTitle", "testIngredients", "testInstructions", "testMealType");
    ...
    void testDeletefromRecipeList() {
        recipeList.add(new Recipe("testTitle0", "testIngredients0", "testInstructions0", "testMealType0"));
        recipeList.add(new Recipe("testTitle1", "testIngredients1", "testInstructions1", "testMealType1"));
    ...
    void testGetRecipeListSize() {
        recipeList.add(new Recipe("testTitle0", "testIngredients0", "testInstructions0", "testMealType0"));
        recipeList.add(new Recipe("testTitle1", "testIngredients1", "testInstructions1", "testMealType0"));
    ...
    void testGetIndexFromRecipeList() {
        Recipe recipe0 = new Recipe("testTitle0", "testIngredients0", "testInstructions0", "testMealType0");
        Recipe recipe1 = new Recipe("testTitle1", "testIngredients1", "testInstructions1", "testMealType1");
        Recipe recipe2 = new Recipe("testTitle2", "testIngredients1", "testInstructions2", "testMealType2");
    ...
    void testSavingToCSV() throws IOException, CsvValidationException {
        recipeList.add(new Recipe("testTitle0", "testIngredient0", "testTitle0", "testMealType0"));
        recipeList.add(new Recipe("testTitle1", "testIngredient1", "testTitle1", "testMealType1"));
        recipeList.add(new Recipe("testTitle2", "testIngredient2", "testTitle2", "testMealType2"));
        recipeList.add(new Recipe("testTitle3", "testIngredient3", "testTitle3", "testMealType3"));
    ...
    // Test loading from csv and checking if the title is correct retrived by
    // getTitle()
    @Test
    ...
    // Test loading from csv and checking if the Ingredients is correct retrived by
    // getIngredients()
    @Test
    ...
    // Test loading from csv and checking if the Instructions are correct retrived
    // by getInstructions()
    @Test
    ...
    void S1_BDD1and2() throws IOException, CsvValidationException {
        ...
        Recipe pizza = new Recipe("Pizza", "cheese,flour", "put pizza in oven", "lunch");
        Recipe burger = new Recipe("Burger", "Meat, Cheese", "put burger in the oven", "dinner");

        recipeList.add(pizza);
        recipeList.add(burger);
        /*
         * Caitlin wants to see the first recipe description, if she clicks on Pizza,
         * she should see
    ...
    Recipe createRecipe(String mockTitle, String mealType, String ingredients, Boolean recognized) {
        ...
        return new Recipe((mealType + mockTitle), ingredients, instructions, mealType);
    }
    ...
    void S4_BDD1() throws IOException, CsvValidationException {
        Recipe pizza = new Recipe("Pizza", "cheese, pepperoni, flour", "add pepperoni put pizza in oven", "lunch");
        recipeList.add(pizza);
