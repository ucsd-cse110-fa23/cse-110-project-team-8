...
public class Footer extends HBox {
    ...
    public void switchScene1() {
        ...
        Text text3 = new Text("'Start Recording' then say your meal type. Press 'Stop Recording' when you are done speaking. ");
        ...
        startRecButton.setOnAction(e -> System.out.println("Start Recording Button Clicked")); // Add Temporary action to the button
        ...
        stopRecButton.setOnAction(e -> switchScene2()); // Switching to second scene
    ...
    public void switchScene2(){
        ...
        Text text2 = new Text("'Start Recording' then say your meal type. Press 'Stop Recording' when you are done speaking. ");
